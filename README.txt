...
Tags: admin, disable widgets, sidebar widgets, widgets
...
Original plugin by [Zaantar](http://zaantar.eu/).
...
1. [Download the plugin zip file](https://downloads.wordpress.org/plugin/disable-widgets.zip) and save it to your computer.
...
1. Disable the widgets you don't need.
2. The Widgets admin page with many widgets disabled.
